...
import HomeFooter from "./assets/footer/Footer";
...
const App = () => {
    ...
    useEffect(() => {
        document.title = "Home | Oyebanji Gabriel"
    }, []);
    return (
        <>
        {/* App Navbar */}
        <nav className="container-fluid px-0">
            <div className="container-fluid px-0 py-3 d-flex flex-column align-items-end">
                <div className="row justify-content-xl-center justify-content-lg-center justify-content-md-center justify-content-sm-center w-75 mx-auto align-items-center w-100">
                    <div className="col-sm-4 col-md-3 col-lg-3 px-0 d-flex justify-content-md-between justify-content-lg-around">
                        <ul className="list-unstyled mb-0 d-flex justify-content-around justify-content-sm-around justify-content-md-between justify-content-lg-between w-100">
                            <li>
                                <Link className="text-secondary text-decoration-none fs-6" to={"/"}>Home</Link>
                            </li>
                            <li>
                                <Link className="text-secondary text-decoration-none fs-6" to={"/user/login"}>Log in</Link>
                            </li>
                            <li>
                                <Link className="text-secondary text-decoration-none fs-6" to={"/admin/dashboard"}>Dashboard</Link>
                            </li>
                        </ul>
                    </div>
                    <div className="col-sm-2 col-md-4 col-lg-4 mb-0 p-0 d-flex justify-content-center justify-content-xs-center justify-content-sm-center justify-content-md-center justify-content-lg-center">
                    ...
                    <div className="container p-0">
                        ...
                        <div className="row align-items-center pb-lg-4 justify-content-lg-end justify-content-md-center justify-content-between w-100 m-0 ps-lg-5 mb-md-5">                
                            ...
                            <div className="col-xl-6 col-lg-5 d-lg-flex d-md-none d-none p-0">
                                <img className="img-fluid w-100" src={FirstImg} alt="icon" />
                            </div>
                        </div>
                        {/* END:  Row Col 1 */}
                        ...
                        <div className="row justify-content-center py-lg-5  mx-auto align-items-center mb-md-5">
                            ...
                            <div className="col-lg-5 d-none d-md-none d-lg-block p-0">
                                <img className="img-fluid w-100" src={SecondImg} alt="icon" />
                            </div>
                        </div>
                        {/* END:  Row Col 2 */}
